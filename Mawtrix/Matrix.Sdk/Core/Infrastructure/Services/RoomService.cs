...
using Mawtrix.Matrix.Sdk.Core.Infrastructure.Dto.Room.Create;
using Mawtrix.Matrix.Sdk.Core.Infrastructure.Dto.Room.Join;
using Mawtrix.Matrix.Sdk.Core.Infrastructure.Dto.Room.Joined;
using Mawtrix.Matrix.Sdk.Core.Infrastructure.Dto.Room.Manage;
using Newtonsoft.Json;
using Newtonsoft.Json.Linq;

namespace Mawtrix.Matrix.Sdk.Core.Infrastructure.Services
{
